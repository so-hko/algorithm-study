...
### 느낀점
하~완벽히 이해했다~ 나는 바보^^ 변수 선언을 안했었네...그래서 런타임 네임에러가 났었구나...내가 쓰는 파이썬 컴파일러는 3.11이라서 if문 처리과정에서 백준의 파이썬 3.7 컴파일러와 차이가 있었다... 그래서 내환경에서는 잘되고 백준에서는 오류가 떴었던...아무튼 변수선언은 기본인데...이걸 발견못해서 2시간이나 헤매다니..너무 슬프지만 잘해결되어서 기쁘다..
